...
public class FindElectricianAdepter extends RecyclerView.Adapter<FindElectricianAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<Registration> driverList = new ArrayList<>();
    private FindElectricianAdepter.OnItemClickListener mListener;

    public FindElectricianAdepter(Context context, ArrayList<Registration> driverList) {
    ...
    @NonNull
    @Override
    public FindElectricianAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hire_electrician_view,viewGroup,false);
        return new FindElectricianAdepter.MyViewHolder(v,context, driverList);
    }
    @Override
    public void onBindViewHolder(@NonNull final FindElectricianAdepter.MyViewHolder myViewHolder, int i) {
        ...
        Picasso.with(context)
                ...
                .fit()
                .placeholder(R.drawable.electrician)
                .centerCrop()
    ...
    public void setOnItemClickListener(FindElectricianAdepter.OnItemClickListener listener){
        mListener = listener;
    }
