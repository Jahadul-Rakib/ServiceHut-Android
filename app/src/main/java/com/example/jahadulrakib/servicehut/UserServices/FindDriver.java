...
public class FindDriver extends AppCompatActivity implements FindDriverAdepter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FindDriverAdepter(FindDriver.this, driverList);
        adapter.setOnItemClickListener(FindDriver.this);
        layoutManager = new LinearLayoutManager(FindDriver.this);
    ...
    public void OnItemClick(final int position) {
        ...
        if (driverlistNext == null) {
            ...
            dialog.setContentView(R.layout.hire_driver);
            ...
            Query queery = availableDriverRefarence.orderByChild("driverId").equalTo(driverId);
            ...
            Query queery1 = availableDriverRefarence.orderByChild("driverId").equalTo(driverId);
            ...
            selectLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(FindDriver.this,GetLocationMapsActivity.class);
            ...
            hireDriver.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HireDriver hireDriver = new HireDriver(userId, driverId, jobId, jobStatus, type, hireForDay, dateOfHire, detailInfo, userNumber, totalPrice,lat,lon);
                    createJobRefarence.child(jobId).setValue(hireDriver);
                    Toast.makeText(FindDriver.this, "Hire Request Submitted Successfully.", Toast.LENGTH_SHORT).show();
                    mRecyclerView.setAdapter(adapter);
                    adapter.setOnItemClickListener(FindDriver.this);
                    dialog.dismiss();
                }
            ...
            call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(FindDriver.this,
