...
public class NurseRejectNotificationAdepter extends RecyclerView.Adapter<NurseRejectNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireNurse> driverjobList = new ArrayList<>();
    private NurseRejectNotificationAdepter.OnItemClickListener mListener;

    public NurseRejectNotificationAdepter(Context context, ArrayList<HireNurse> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemNurseClicks(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public NurseRejectNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_nurse_view,viewGroup,false);
        return new NurseRejectNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final NurseRejectNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemNurseClicks(int position);
    }
    public void setOnItemClickListener(NurseRejectNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
