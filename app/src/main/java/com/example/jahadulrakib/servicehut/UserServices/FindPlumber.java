...
public class FindPlumber extends AppCompatActivity implements FindGassFitterAdepter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FindGassFitterAdepter(FindPlumber.this, driverList);
        layoutManager = new LinearLayoutManager(FindPlumber.this);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(FindPlumber.this);
    ...
    public void OnItemClick(final int position) {
        ...
        if (driverlistNext ==null){
            ...
            Query queery = availableDriverRefarence.orderByChild("plumberId").equalTo(driverId);
            queery.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot:dataSnapshot.getChildren()){
                        HirePlumber hireDriver = snapshot.getValue(HirePlumber.class);
            ...
            Query queery1 = availableDriverRefarence.orderByChild("plumberId").equalTo(driverId);
            ...
            selectLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(FindPlumber.this,GetLocationMapsActivity.class);
            ...
            hireDriver.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HirePlumber hireDriver = new HirePlumber(userId,driverId,jobId,jobStatus,dateOfHire,detailInfo,userNumber,price,lat,lon);
                    createJobRefarence.child(jobId).setValue(hireDriver);
                    Toast.makeText(FindPlumber.this, "Hire Request Submitted Successfully.", Toast.LENGTH_SHORT).show();
                    mRecyclerView.setAdapter(adapter);
                    adapter.setOnItemClickListener(FindPlumber.this);
                    dialog.dismiss();
                }
            ...
            call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(FindPlumber.this,
