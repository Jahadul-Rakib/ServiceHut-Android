...
public class ElectricianAcceptNotificationAdepter extends RecyclerView.Adapter<ElectricianAcceptNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireElectrician> driverjobList = new ArrayList<>();
    private ElectricianAcceptNotificationAdepter.OnItemClickListener mListener;

    public ElectricianAcceptNotificationAdepter(Context context, ArrayList<HireElectrician> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemElectricianClick(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public ElectricianAcceptNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_electrician_view,viewGroup,false);
        return new ElectricianAcceptNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final ElectricianAcceptNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemElectricianClick(int position);
    }
    public void setOnItemClickListener(ElectricianAcceptNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
