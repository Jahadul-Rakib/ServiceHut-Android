...
public class DriverNotNowNotificationAdepter extends RecyclerView.Adapter<DriverNotNowNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireDriver> driverjobList = new ArrayList<>();
    private DriverNotNowNotificationAdepter.OnItemClickListener mListener;

    public DriverNotNowNotificationAdepter(Context context, ArrayList<HireDriver> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnDItemClicks(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public DriverNotNowNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_driver_view,viewGroup,false);
        return new DriverNotNowNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final DriverNotNowNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnDItemClicks(int position);
    }
    public void setOnItemClickListener(DriverNotNowNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
