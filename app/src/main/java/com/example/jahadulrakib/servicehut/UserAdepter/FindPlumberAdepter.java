...
public class FindPlumberAdepter extends RecyclerView.Adapter<FindPlumberAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<Registration> driverList = new ArrayList<>();
    private FindPlumberAdepter.OnItemClickListener mListener;

    public FindPlumberAdepter(Context context, ArrayList<Registration> driverList) {
    ...
    @NonNull
    @Override
    public FindPlumberAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hire_plumber_view,viewGroup,false);
        return new FindPlumberAdepter.MyViewHolder(v,context, driverList);
    }
    @Override
    public void onBindViewHolder(@NonNull final FindPlumberAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(FindPlumberAdepter.OnItemClickListener listener){
        mListener = listener;
    }
