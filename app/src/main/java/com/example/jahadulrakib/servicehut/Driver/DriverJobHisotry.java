...
public class DriverJobHisotry extends Fragment implements DriverJobHistoryAdepter.OnItemClickListener {

    private RecyclerView nRecyclerView;
    RecyclerView.LayoutManager layoutManagers;
    private ArrayList<HireDriver> compliteList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapters = new DriverJobHistoryAdepter(getActivity(), compliteList);
        ...
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapters.setOnItemClickListener(DriverJobHisotry.this);
            }
