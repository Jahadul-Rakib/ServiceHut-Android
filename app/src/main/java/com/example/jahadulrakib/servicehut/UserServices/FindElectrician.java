...
public class FindElectrician extends AppCompatActivity implements FindElectricianAdepter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FindElectricianAdepter(FindElectrician.this, driverList);
        layoutManager = new LinearLayoutManager(FindElectrician.this);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(FindElectrician.this);
    ...
    public void OnItemClick(final int position) {
        ...
        if (driverlistNext == null) {
            ...
            Query queery = availableDriverRefarence.orderByChild("electricianId").equalTo(driverId);
            queery.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        HireElectrician hireDriver = snapshot.getValue(HireElectrician.class);
            ...
            Query queery1 = availableDriverRefarence.orderByChild("electricianId").equalTo(driverId);
            ...
            selectLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(FindElectrician.this,GetLocationMapsActivity.class);
            ...
            hireDriver.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HireElectrician hireDriver = new HireElectrician(userId, driverId, jobId, jobStatus, dateOfHire, detailInfo, userNumber, price,lat,lon);
                    createJobRefarence.child(jobId).setValue(hireDriver);
                    Toast.makeText(FindElectrician.this, "Hire Request Submitted Successfully.", Toast.LENGTH_SHORT).show();
                    mRecyclerView.setAdapter(adapter);
                    adapter.setOnItemClickListener(FindElectrician.this);
                    dialog.dismiss();
                }
            ...
            call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(FindElectrician.this,
