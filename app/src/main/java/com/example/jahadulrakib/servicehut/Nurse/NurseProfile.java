...
public class NurseProfile extends Fragment implements NurseAvailableJobAdepter.OnItemClickListener,NurseJobHistoryAdepter.OnItemClickListener,NotificationAdeptere.OnItemClickListener {
    ...
    private ArrayList<HireNurse> jobList;
    private ArrayList<HireNurse> acceptList;
    ...
    NurseAvailableJobAdepter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new NurseAvailableJobAdepter(getActivity(), jobList);
        adapters = new NurseJobHistoryAdepter(getActivity(), acceptList);
        ...
        notification.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                notificationAdapter.setOnItemClickListener(NurseProfile.this);
            }
        ...
        Query query = jobRefarence.orderByChild("nurseId").equalTo(userId);
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                jobList.clear();
                for (DataSnapshot job : dataSnapshot.getChildren()) {
                    HireNurse totalJob = job.getValue(HireNurse.class);
                    if(totalJob.getJobStatus().equals("pending")){
                        jobList.add(totalJob);
                    }
                }
                mRecyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(NurseProfile.this);
            }
        ...
        Query getAeecptedJob = jobRefarence.orderByChild("nurseId").equalTo(userId);
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapters.setOnItemClickListener(NurseProfile.this);
            }
    ...
    public void OnItemClick(int position) {
        ...
        final HireNurse hireDriver = jobList.get(position);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HireNurse updayeDrivers = new HireNurse(hireDriver.getUserId(), hireDriver.getNurseId(), jobId,
                ...
                driverID = hireDriver.getNurseId();
    ...
    public void OnItemClicks(int position){
        ...
        final HireNurse hireDrivers = acceptList.get(position);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                jobRefarence = rootReReference.child("driverJob");
                String jobIdNew = jobRefarence.push().getKey();
                HireNurse updayeDriver = new HireNurse(hireDrivers.getUserId(), hireDrivers.getNurseId(), jobId,
