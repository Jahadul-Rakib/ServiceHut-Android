...
public class LabourRejectNotificationAdepter extends RecyclerView.Adapter<LabourRejectNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireLabour> driverjobList = new ArrayList<>();
    private LabourRejectNotificationAdepter.OnItemClickListener mListener;

    public LabourRejectNotificationAdepter(Context context, ArrayList<HireLabour> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemLabourClicks(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public LabourRejectNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_labour_view,viewGroup,false);
        return new LabourRejectNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final LabourRejectNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemLabourClicks(int position);
    }
    public void setOnItemClickListener(LabourRejectNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
