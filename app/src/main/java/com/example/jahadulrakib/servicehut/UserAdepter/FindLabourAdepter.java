...
public class FindLabourAdepter extends RecyclerView.Adapter<FindLabourAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<Registration> driverList = new ArrayList<>();
    private FindLabourAdepter.OnItemClickListener mListener;

    public FindLabourAdepter(Context context, ArrayList<Registration> driverList) {
    ...
    @NonNull
    @Override
    public FindLabourAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hire_labour_view,viewGroup,false);
        return new FindLabourAdepter.MyViewHolder(v,context, driverList);
    }
    @Override
    public void onBindViewHolder(@NonNull final FindLabourAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(FindLabourAdepter.OnItemClickListener listener){
        mListener = listener;
    }
