...
public class LabourJobHisotry extends Fragment implements LabourJobHistoryAdepter.OnItemClickListener {

    private RecyclerView nRecyclerView;
    RecyclerView.LayoutManager layoutManagers;
    private ArrayList<HireLabour> compliteList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapters = new LabourJobHistoryAdepter(getActivity(), compliteList);
        ...
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapters.setOnItemClickListener(LabourJobHisotry.this);
            }
