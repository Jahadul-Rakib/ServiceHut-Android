...
public class DriverRejectNotificationAdepter extends RecyclerView.Adapter<DriverRejectNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireDriver> driverjobList = new ArrayList<>();
    private DriverRejectNotificationAdepter.OnItemClickListener mListener;

    public DriverRejectNotificationAdepter(Context context, ArrayList<HireDriver> driverjobList) {
    ...
    @NonNull
    @Override
    public DriverRejectNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_driver_view,viewGroup,false);
        return new DriverRejectNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final DriverRejectNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(DriverRejectNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
