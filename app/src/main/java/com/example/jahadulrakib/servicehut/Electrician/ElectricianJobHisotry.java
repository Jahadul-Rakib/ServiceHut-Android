...
public class ElectricianJobHisotry extends Fragment implements ElectricianHistoryAdepter.OnItemClickListener {

    private RecyclerView nRecyclerView;
    RecyclerView.LayoutManager layoutManagers;
    private ArrayList<HireElectrician> compliteList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapters = new ElectricianHistoryAdepter(getActivity(), compliteList);
        ...
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapters.setOnItemClickListener(ElectricianJobHisotry.this);
            }
