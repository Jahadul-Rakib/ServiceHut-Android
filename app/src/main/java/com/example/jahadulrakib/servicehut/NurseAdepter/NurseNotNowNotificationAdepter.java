...
public class NurseNotNowNotificationAdepter extends RecyclerView.Adapter<NurseNotNowNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireNurse> driverjobList = new ArrayList<>();
    private NurseNotNowNotificationAdepter.OnItemClickListener mListener;

    public NurseNotNowNotificationAdepter(Context context, ArrayList<HireNurse> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemNClick(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public NurseNotNowNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_nurse_view,viewGroup,false);
        return new NurseNotNowNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final NurseNotNowNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemNClick(int position);
    }
    public void setOnItemClickListener(NurseNotNowNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
