...
public class PlumberAvailableJobAdepter extends RecyclerView.Adapter<PlumberAvailableJobAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HirePlumber> driverjobList = new ArrayList<>();
    private PlumberAvailableJobAdepter.OnItemClickListener mListener;

    public PlumberAvailableJobAdepter(Context context, ArrayList<HirePlumber> driverjobList) {
    ...
    @NonNull
    @Override
    public PlumberAvailableJobAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_plumber_view,viewGroup,false);
        return new PlumberAvailableJobAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final PlumberAvailableJobAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(PlumberAvailableJobAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
