...
public class FindGassFitterAdepter extends RecyclerView.Adapter<FindGassFitterAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<Registration> driverList = new ArrayList<>();
    private FindGassFitterAdepter.OnItemClickListener mListener;

    public FindGassFitterAdepter(Context context, ArrayList<Registration> driverList) {
    ...
    @NonNull
    @Override
    public FindGassFitterAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hire_gas_fitter_view,viewGroup,false);
        return new FindGassFitterAdepter.MyViewHolder(v,context, driverList);
    }
    @Override
    public void onBindViewHolder(@NonNull final FindGassFitterAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(FindGassFitterAdepter.OnItemClickListener listener){
        mListener = listener;
    }
