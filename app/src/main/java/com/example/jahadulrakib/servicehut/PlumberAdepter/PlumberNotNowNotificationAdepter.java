...
public class PlumberNotNowNotificationAdepter extends RecyclerView.Adapter<PlumberNotNowNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HirePlumber> driverjobList = new ArrayList<>();
    private PlumberNotNowNotificationAdepter.OnItemClickListener mListener;

    public PlumberNotNowNotificationAdepter(Context context, ArrayList<HirePlumber> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemPlClick(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public PlumberNotNowNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_plumber_view,viewGroup,false);
        return new PlumberNotNowNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final PlumberNotNowNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemPlClick(int position);
    }
    public void setOnItemClickListener(PlumberNotNowNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
