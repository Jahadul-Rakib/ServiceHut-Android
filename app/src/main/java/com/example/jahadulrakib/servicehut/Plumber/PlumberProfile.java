...
public class PlumberProfile extends Fragment implements PlumberAvailableJobAdepter.OnItemClickListener,
        PlumberHistoryAdepter.OnItemClickListener,
    ...
    private ArrayList<HirePlumber> jobList;
    private ArrayList<HirePlumber> acceptList;
    ...
    PlumberAvailableJobAdepter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PlumberAvailableJobAdepter(getActivity(), jobList);
        adapters = new PlumberHistoryAdepter(getActivity(), acceptList);
        ...
        notification.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                notificationAdapter.setOnItemClickListener(PlumberProfile.this);
            }
        ...
        Query query = jobRefarence.orderByChild("plumberId").equalTo(userId);
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                jobList.clear();
                for (DataSnapshot job : dataSnapshot.getChildren()) {
                    HirePlumber totalJob = job.getValue(HirePlumber.class);
                    if(totalJob.getJobStatus().equals("pending")){
                        jobList.add(totalJob);
                    }
                }
                mRecyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(PlumberProfile.this);
            }
        ...
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapters.setOnItemClickListener(PlumberProfile.this);
            }
    ...
    public void OnItemClick(int position) {
        ...
        final HirePlumber hireDriver = jobList.get(position);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HirePlumber updayeDrivers = new HirePlumber(hireDriver.getUserId(), hireDriver.getPlumberId(), jobId,
                        "NotNow", hireDriver.getDateOfHire(),
                        hireDriver.getDetailInfo(), hireDriver.getNumber(), hireDriver.getTotals(),hireDriver.getLat(),hireDriver.getLon());
                jobRefarence.child(jobIdNew).setValue(updayeDrivers);

                String userId = hireDriver.getUserId();
                driverID = hireDriver.getPlumberId();
    ...
    public void OnItemClicks(int position){
        ...
        final HirePlumber hireDrivers = acceptList.get(position);
            ...
            public void onClick(View v) {
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        radapter.setOnItemClickListener(PlumberProfile.this);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                jobRefarence = rootReReference.child("driverJob");
                String jobIdNew = jobRefarence.push().getKey();
                HirePlumber updayeDriver = new HirePlumber(hireDrivers.getUserId(), hireDrivers.getPlumberId(), jobId,
                ...
                HirePlumber updayeDrivers = new HirePlumber(hireDrivers.getUserId(), hireDrivers.getPlumberId(), jobId,
                        "NotNow", hireDrivers.getDateOfHire(), hireDrivers.getDetailInfo(),
                        hireDrivers.getNumber(), hireDrivers.getTotals(),hireDrivers.getLat(),hireDrivers.getLon());
                jobRefarence.child(jobIdNew).setValue(updayeDrivers);

                Transection transection = new Transection(jobId,hireDrivers.getPlumberId(),25);
                transectionRefarence.child(jobId).setValue(transection);
                String userId = hireDrivers.getUserId();
                driverID = hireDrivers.getPlumberId();
                rejectMessage(jobId,userId,driverID );
                dialog.dismiss();
            }
        });
