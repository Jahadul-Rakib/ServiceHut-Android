...
public class FindNurse extends AppCompatActivity implements FindNurseAdepter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FindNurseAdepter(FindNurse.this, driverList);
        layoutManager = new LinearLayoutManager(FindNurse.this);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(FindNurse.this);
    ...
    public void OnItemClick(final int position) {
        ...
        if (driverlistNext ==null){
            ...
            dialog.setContentView(R.layout.hire_nurse);
            ...
            Query queery = availableDriverRefarence.orderByChild("nurseId").equalTo(driverId);
            queery.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot:dataSnapshot.getChildren()){
                        HireNurse hireDriver = snapshot.getValue(HireNurse.class);
            ...
            Query queery1 = availableDriverRefarence.orderByChild("nurseId").equalTo(driverId);
            ...
            selectLocation.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(FindNurse.this,GetLocationMapsActivity.class);
            ...
            hireDriver.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HireNurse hireDriver = new HireNurse(userId,driverId,jobId,jobStatus, type,hireForDay,dateOfHire,detailInfo,userNumber,totalPrice,lat,lon);
                    createJobRefarence.child(jobId).setValue(hireDriver);
                    Toast.makeText(FindNurse.this, "Hire Request Submitted Successfully.", Toast.LENGTH_SHORT).show();
                    mRecyclerView.setAdapter(adapter);
                    adapter.setOnItemClickListener(FindNurse.this);
                    dialog.dismiss();
                }
            ...
            call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (ActivityCompat.checkSelfPermission(FindNurse.this,
