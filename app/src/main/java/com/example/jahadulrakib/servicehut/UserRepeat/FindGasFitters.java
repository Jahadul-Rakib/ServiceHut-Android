...
public class FindGasFitters extends AppCompatActivity implements FindGassFitterAdepter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        hireGesFitter = (HireGesFitter) i.getSerializableExtra("object");
        ...
        adapter = new FindGassFitterAdepter(FindGasFitters.this, driverList);
        layoutManager = new LinearLayoutManager(FindGasFitters.this);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(FindGasFitters.this);
        ...
        if (driverlistNext ==null){
            ...
            yes.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    hireGesFitter = new HireGesFitter(hireGesFitter.getUserId(), driverId, hireGesFitter.getJobId(),
                            "pending",
                            hireGesFitter.getDateOfHire(),
                            hireGesFitter.getDetailInfo(), hireGesFitter.getNumber(), hireGesFitter.getTotals(),hireGesFitter.getLat(),
                            hireGesFitter.getLon());
                    availableDriverRefarence.child(hireGesFitter.getJobId()).setValue(hireGesFitter);
                    dialog.dismiss();
                }
            });
