...
public class SetLocationMapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks,
    ...
    public void mapOperations() {
        ...
        Double lt = latLang.getLatiture();
        Double ln = latLang.getLongiture();
