...
import com.example.jahadulrakib.servicehut.ElectricianAdapter.ElectricianAvailableJobAdepter;
...
public class ElectricianProfile extends Fragment implements ElectricianAvailableJobAdepter.OnItemClickListener,
        ItemAdepter.OnItemClickListener,
        ElectricianHistoryAdepter.OnItemClickListener,NotificationAdeptere.OnItemClickListener {
    ...
    private ArrayList<HireElectrician> jobList;
    private ArrayList<HireElectrician> acceptList;
    ...
    ElectricianAvailableJobAdepter adapter;
    ElectricianHistoryAdepter adapters;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new ElectricianAvailableJobAdepter(getActivity(), jobList);
        adapters = new ElectricianHistoryAdepter(getActivity(), acceptList);
        ...
        notification.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                notificationAdapter.setOnItemClickListener(ElectricianProfile.this);
            }
        ...
        Query query = jobRefarence.orderByChild("electricianId").equalTo(userId);
        query.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                jobList.clear();
                for (DataSnapshot job : dataSnapshot.getChildren()) {
                    HireElectrician totalJob = job.getValue(HireElectrician.class);
                    if(totalJob.getJobStatus().equals("pending")){
                        jobList.add(totalJob);
                    }
                }
                mRecyclerView.setAdapter(adapter);
                adapter.setOnItemClickListener(ElectricianProfile.this);
            }
        ...
        Query getAeecptedJob = jobRefarence.orderByChild("electricianId").equalTo(userId);
        getAeecptedJob.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                acceptList.clear();
                for (DataSnapshot job : dataSnapshot.getChildren()) {
                    HireElectrician currentJob = job.getValue(HireElectrician.class);
                ...
                adapters.setOnItemClickListener(ElectricianProfile.this);
            }
    ...
    public void OnItemClick(int position) {
        ...
        final HireElectrician hireDriver = jobList.get(position);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HireElectrician updayeDrivers = new HireElectrician(hireDriver.getUserId(), hireDriver.getElectricianId(), jobId,
                        "NotNow",hireDriver.getDateOfHire(), hireDriver.getDetailInfo(),
                        hireDriver.getNumber(), hireDriver.getTotals(),hireDriver.getLat(),hireDriver.getLon());
                jobRefarence.child(jobIdNew).setValue(updayeDrivers);

                String userId = hireDriver.getUserId();
                driverID = hireDriver.getElectricianId();
    ...
    public void OnItemClicks(int position){
        ...
        final HireElectrician hireDrivers = acceptList.get(position);
            ...
            public void onClick(View v) {
                ...
                query.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        radapter.setOnItemClickListener(ElectricianProfile.this);
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                jobRefarence = rootReReference.child("driverJob");
                HireElectrician updayeDriver = new HireElectrician(hireDrivers.getUserId(), hireDrivers.getElectricianId(), jobId,
                ...
                String jobIdNew = jobRefarence.push().getKey();
                HireElectrician updayeDrivers = new HireElectrician(hireDrivers.getUserId(), hireDrivers.getElectricianId(), jobId,
                        "NotNow",hireDrivers.getDateOfHire(), hireDrivers.getDetailInfo(),
                        hireDrivers.getNumber(), hireDrivers.getTotals(),hireDrivers.getLat(),hireDrivers.getLon());
                jobRefarence.child(jobIdNew).setValue(updayeDrivers);

                Transection transection = new Transection(jobId,hireDrivers.getElectricianId(),25);
                transectionRefarence.child(jobId).setValue(transection);
                String userId = hireDrivers.getUserId();
                driverID = hireDrivers.getElectricianId();
                rejectMessage(jobId,userId,driverID );
