...
public class GasHistoryAdepter extends RecyclerView.Adapter<GasHistoryAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HireGesFitter> driverjobList = new ArrayList<>();
    private GasHistoryAdepter.OnItemClickListener mListener;

    public GasHistoryAdepter(Context context, ArrayList<HireGesFitter> driverjobList) {
    ...
    @NonNull
    @Override
    public GasHistoryAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_gas_fitter_view,viewGroup,false);
        return new GasHistoryAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final GasHistoryAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public void setOnItemClickListener(GasHistoryAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
