...
public class PlumberRejectNotificationAdepter extends RecyclerView.Adapter<PlumberRejectNotificationAdepter.MyViewHolder> {

    private Context context;
    private ArrayList<HirePlumber> driverjobList = new ArrayList<>();
    private PlumberRejectNotificationAdepter.OnItemClickListener mListener;

    public PlumberRejectNotificationAdepter(Context context, ArrayList<HirePlumber> driverjobList) {
        ...
        public void onClick(View v) {
            if (mListener != null){
                ...
                if (position != RecyclerView.NO_POSITION){
                    mListener.OnItemPlumberClicks(position);
                }
            }
        }
    }
    ...
    @NonNull
    @Override
    public PlumberRejectNotificationAdepter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.job_plumber_view,viewGroup,false);
        return new PlumberRejectNotificationAdepter.MyViewHolder(v,context, driverjobList);
    }
    @Override
    public void onBindViewHolder(@NonNull final PlumberRejectNotificationAdepter.MyViewHolder myViewHolder, int i) {
    ...
    public interface OnItemClickListener{
        void OnItemPlumberClicks(int position);
    }
    public void setOnItemClickListener(PlumberRejectNotificationAdepter.OnItemClickListener listener){
        mListener = listener;
    }
}
